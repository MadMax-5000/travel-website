...
const Hero = () => {
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex w-full max-w-4xl flex-col items-center text-center px-4 sm:px-6">

        {/* Small Pill Badge */}
        <div className="mb-6 sm:mb-8 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1.5 sm:px-4 sm:py-1.5 backdrop-blur-md transition-transform hover:scale-105 cursor-default">
          ...
          <span className="text-[10px] sm:text-xs font-medium tracking-wide text-white uppercase">Season Starts Now</span>
        </div>

        {/* Headline */}
        <h1 className="mb-4 sm:mb-6 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight text-white">
          Agadir <span className="font-serif italic text-orange-300">Awaits</span>
        </h1>

        {/* Subtext - clean and readable */}
        <p className="max-w-2xl text-base sm:text-lg md:text-xl text-gray-200 font-light leading-relaxed mb-8 sm:mb-10">
      ...
      {/* Scroll Indicator */}
      <div
        className="absolute bottom-6 sm:bottom-10 left-1/2 z-20 -translate-x-1/2 cursor-pointer transition-opacity hover:opacity-80"
        onClick={scrollToContent}
      >
